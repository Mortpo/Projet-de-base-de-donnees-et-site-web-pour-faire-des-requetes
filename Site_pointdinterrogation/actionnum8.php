...
<?php
        ...
        //Sans genre entrer
		$req = $bdd->query('SELECT Jeu.id, Jeu.titre_du_jeu, Jeu.annee_de_sortie, Supportjeu.support, Jeu.nom_de_la_franchise FROM Jeu INNER JOIN Supportjeu ON Supportjeu.id = Jeu.id WHERE support = \'PS2\'');
